...
class FragmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fragment" do
    assert_difference("Fragment.count") do
      post fragments_url, params: { fragment: { composer_id: @fragment.composer_id, content: @fragment.content, key: @fragment.key, time: @fragment.time, title: @fragment.title } }
    end
  ...
  test "should update fragment" do
    patch fragment_url(@fragment), params: { fragment: { composer_id: @fragment.composer_id, content: @fragment.content, key: @fragment.key, time: @fragment.time, title: @fragment.title } }
