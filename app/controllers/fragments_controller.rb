class FragmentsController < ApplicationController
  before_action :set_fragment, only: %i[ show edit update destroy addclip ]
  ...
  def addclip
    @clip=Clip.new(fragment_id: @fragment.id)
    render "clips/new"
  end
  def show
  end
  ...
  private
    ...
    def fragment_params
      params.require(:fragment).permit(:time, :key, :title, :content, :composer_id)
    end
end
